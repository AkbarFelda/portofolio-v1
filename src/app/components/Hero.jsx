...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex flex-col">
      {/* Main Hero Content */}
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-10 items-center justify-center py-20 px-10">
      ...
      {/* Bottom Section with Arrow and Marquee */}
      {/* <div className="flex flex-col items-center pb-10 space-y-6">
        <div className="flex flex-col items-center space-y-2">
          ...
          >
            <path 
              d="M30 10 Q30 40 30 60" 
              stroke="currentColor" 
              strokeWidth="2" 
              fill="none"
            />
            <path 
              d="M20 50 L30 60 L40 50" 
              stroke="currentColor" 
              strokeWidth="2" 
              fill="none"
            />
          </svg>
          <p className="text-gray-400 text-sm font-gabaritoreguler">
            Explore My Work
          </p>
        </div>
      </div> */}
