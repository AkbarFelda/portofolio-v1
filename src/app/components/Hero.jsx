  ...
  return (
    <div className="relative min-h-screen grid grid-cols-1 md:grid-cols-3 gap-10 items-center justify-center py-20 px-10">
      ...
      <div className="flex flex-col items-center md:items-start space-y-3">
        ...
        <div className="bg-amber-200 p-0.5 w-20 mx-auto md:mx-0 z-10"></div>
        ...
        <a
          href="#contact"
          className="text-amber-200 flex items-center space-x-2 justify-center md:justify-start z-10 mt-2"
        >
